...
<?= \app\helpers\RenderHelper::renderCompetences([
    [
        'Применять',
        'базовые и специальные естественнонаучные и математические знания
    в области информатики и вычислительной техники, достаточные для комплексной
    инженерной деятельности'
    ],
    [
        'Ставить',
        'и решать задачи комплексного анализа, связанные с созданием
    аппаратно-программных средств информационных и автоматизированных систем,
    с использованием базовых и специальных знаний, современных аналитических
    методов и моделей'
    ],
    [
        'Владеть',
        'иностранным языком на уровне, позволяющем работать в иноязычной
    среде, разрабатывать документацию, презентовать и защищать результаты
    комплексной инженерной деятельности'
    ],
    [
        'Использовать',
        'базовые и специальные знания в области проектного менеджмента
    для ведения комплексной инженерной деятельности'
    ],
    [
        'Применять',
        'базовые и специальные знания в области современных
...
<?= \app\helpers\RenderHelper::renderReviews([
    [
        'image' => 'cshukin.jpg',
        'name' => 'Василий Щукин',
        'desc' => 'год выпуска: 2019, работает в: Sibedge,<br/>
должность: frontend engineer<br/>
«Благодаря ТПУ и родной кафедре Программной Инженерии я получил комплексные знания в
сферах проектирования и разработки ПО, аналитики, менеджмента. Я получил фундаментальные
знания, которые могут быть приложены к любому сегменту IT рынка. Хочу поблагодарить всех
преподавателей за их лояльность, теплоту, профессионализм и любовь к профессии!
Направление подготовки &quot;Программная инженерия&quot; - достойное образование для достойного
будущего, и помни, что все в конечном итоге зависит только от тебя.»
',
        'long' => true
    ],
], 'b-pri')?>
