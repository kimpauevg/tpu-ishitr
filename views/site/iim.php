            ...
            <div class="row flex-column flex-lg-row justify-content-start justify-content-lg-between">
                <div class="col-auto left-block">
                    ...
                    <div class="section-text">
                        на высокотехнологичных предприятиях сферы информационных и компьютерных технологий, глобальных и локальных сетей ЭВМ,
                        космической техники, беспилотных летательных аппаратов, электроники, автоматики, систем управления, технической диагностики,
                        распознавания образов, автоматизации, научных исследований, комплексных испытаний, контроля
                        <br/><br/>
                        Компании:
