            ...
            <div class="row flex-column flex-lg-row justify-content-start justify-content-lg-between">
                <div class="col-auto left-block">
                    ...
                    <div class="section-text">
                        руководителей групп, руководителей проектов, руководителей отделов.<br/><br/>
                        Компании: ОАО «Томскнефть ВНК», ОАО «ТомскНИПИнефть», «Томский НИМЦ РАН», ООО «Полюс»,
                        ООО «Нефтехим», ООО «Элеси», ООО «Эко-Томск», ООО «Элекард», ООО «САС Институт» (г. Москва),
                        Томский филиал ОАО «Телеком», ПАО «Сбербанк» (г. Москва), Центральный Банк России (г. Томск).
                    </div>
                </div>
...
<?= \app\helpers\RenderHelper::renderTeachers([
    [
        'image' => 'gubin.jpg',
        'name' => 'Губин Евгений Иванович',
        'desc' => '
        Кандидат физико-математических наук доцент отделения информационных технологий
        <br/>
                   Дисциплины: 
                   <br/>«Введение в большие данные»

',
    ],
    [
        'image' => 'sokolova.jpg',
        'name' => 'Соколова Вероника Валерьевна',
        'desc' => '
        Кандидат технических наук, доцент отделения информационных технологий
                <br/>
                   Дисциплины: 
                   <br/>«Современные концепции организации баз данных»
...
Кандидат технических наук, доцент отделения информационных технологий
                        <br/>
                   Дисциплины: 
                   <br/>«Интеллектуаль-ный анализ Web-данных»
