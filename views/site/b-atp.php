            ...
            <div class="row flex-column flex-lg-row justify-content-start justify-content-lg-between">
                <div class="col-auto left-block">
                    ...
                    <div class="section-text">
                        ...
                        АО «Транснефть – Сибирь», АО «Томсктрансгаз»,<br/>
                        АО «ТомскНИПИнефть», ЗАО «ЭлеСи», <br/>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        ...
                        <div class="info-text">
                            ...
                            и робототехники Инженерной школы информационных технологий и робототехники.                        </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="light-grey-holder">
            ...
            <div class="container-wide">
                <div class="programs-list row">
                    <a href="/bdis" class="program-item">
